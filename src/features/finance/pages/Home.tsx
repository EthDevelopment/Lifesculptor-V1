...
const cards: CardDef[] = [
  { title: "Finance", to: "/finance", icon: PiggyBank, desc: "Track net worth, cashflow, and plan ahead.", color: "emerald" },
  { title: "Health", to: "/health", icon: HeartPulse, desc: "Habits, metrics, and training (coming soon).", color: "red" },
  { title: "Work", to: "/work", icon: Briefcase, desc: "Projects, tasks, and systems (coming soon).", color: "amber" },
  { title: "Mind", to: "/mind", icon: Brain, desc: "Principles, reflections, and learning (coming soon).", color: "violet" },
];
  ...
  <div className="grid grid-cols-1 gap-8 md:grid-cols-12">
    ...
    <div className="md:col-span-8">
      ...
      <p className="mt-4 max-w-2xl text-neutral-400">
        Four focused arenas. Clean tools. Your data. Start with one pillar and
        watch momentum compound across the rest.
      </p>
    ...
    <aside className="md:col-span-4">
      <div className="sticky top-6 rounded-2xl border border-neutral-800/60 bg-neutral-900/50 p-6 shadow-[0_8px_30px_rgba(0,0,0,.35)]">
        ...
        <h3 className="text-xl font-semibold text-neutral-100">Stay in the loop</h3>
        <p className="mt-2 text-sm leading-relaxed text-neutral-400">
          New features, principles, and prompts that help you compound progress.
